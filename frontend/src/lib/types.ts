...
export interface Appointment {
  ...
  doctor_assignment_known?:boolean; is_quick_booking?:boolean; laser_device_key?:string|null; laser_device_name?:string|null; laser_pulses_used?:number|null; discount_minor?:number;
