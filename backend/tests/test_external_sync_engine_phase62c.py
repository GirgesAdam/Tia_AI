...
def _create_sqlite_schema(engine) -> None:
    ddl = [
        ...
        CREATE TABLE appointments (
            ...
            price_minor INTEGER, discount_minor INTEGER DEFAULT 0, currency VARCHAR(3), laser_device_key VARCHAR(40), laser_device_name VARCHAR(120), payment_status VARCHAR(16),
