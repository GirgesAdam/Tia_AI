...
def test_24_hour_reminder_is_scheduled_before_appointment() -> None:
    ...
    assert when == datetime(2026, 8, 19, 18, 0, tzinfo=timezone.utc)


def test_no_show_followup_is_30_minutes_after_no_show() -> None:
    no_show = datetime(2026, 8, 20, 18, 0, tzinfo=timezone.utc)
    ...
    assert when == datetime(2026, 8, 20, 18, 30, tzinfo=timezone.utc)
