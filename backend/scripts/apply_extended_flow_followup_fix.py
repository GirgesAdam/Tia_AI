...
def main() -> int:
    # Strengthen semantic follow-up rules without adding lexical routing.
    replace_once(
    ...
    # Test fixtures must not assume a particular doctor has evening shifts.
    replace_once(
    ...
    print("Applied structured active-booking follow-up fix and fixture repair.")
    return 0
